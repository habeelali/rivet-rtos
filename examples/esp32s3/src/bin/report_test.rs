...
#[rivet::task(priority = 0, stack = 1024)]
...
fn main() -> ! {
    ...
    let _ = rivet::spawn_ptask!(stack = 1024, priority = 2, entry = logger_a, arg = ());
    let _ = rivet::spawn_ptask!(stack = 1024, priority = 2, entry = logger_b, arg = ());
    rivet::run();
}
